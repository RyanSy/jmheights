...
// Source doc:  https://docs.google.com/document/d/1TLFqQ_XYzYqgeACCeceFopin1vleNQrQO8dxN1yuBGA
// Content file: content/commercial/hvac.md
const MD_PATH = path.join(process.cwd(), 'content/commercial/hvac.md')
