...
// Source doc:  https://docs.google.com/document/d/1HGPi8gyV0HeXhFU5UwO625kYjiJuiCW7WZF44HKNcRo
// Content file: content/commercial/plumbing.md
const MD_PATH = path.join(process.cwd(), 'content/commercial/plumbing.md')
