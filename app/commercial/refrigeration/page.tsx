...
// Source doc:  https://docs.google.com/document/d/1TilrOxoVd8h7FTjPw_DfqQt9LqKD0Wwtp8lPbqZhOOY
// Content file: content/commercial/refrigeration.md
const MD_PATH = path.join(process.cwd(), 'content/commercial/refrigeration.md')
