...
// Source doc:  https://docs.google.com/document/d/1tkACCmxswfLtEI_8guDnyt2Zy_TWrZYvm3EY0vMTJ2k
// Content file: content/contact.md
const MD_PATH = path.join(process.cwd(), 'content/contact.md')
